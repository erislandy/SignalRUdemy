...
namespace SignalRUdemy.Hubs
{
    ...
    {
        public static List<string> GroupsJoined { get;} = new List<string>();
        public async Task JoinHouse (string houseName)
        {
            if(!GroupsJoined.Contains(Context.ConnectionId + ":" + houseName))
            {
                ...
                await Clients.Others.SendAsync("userJoined", houseName);
        ...
        public async Task LeaveHouse(string houseName)
        {
            if (GroupsJoined.Contains(Context.ConnectionId + ":" + houseName))
            {
                ...
                await Clients.Others.SendAsync("userRemoved", houseName);
